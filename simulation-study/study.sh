...
for rep in $(seq 1 100)   # going to 4 right now just to get some preliminary results, we don't need every replicate yet...
do
    ...
    do
        ...
        do
            ...
            julia --project=../.. -t6 ./perfect_subsets.jl ${top} ${rep} ${maxsubsetsize} "internode_count" 1000 2>> perfect_subsets.log
        done
    done
done